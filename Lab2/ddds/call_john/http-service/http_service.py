...
def get_phone_num():
    ...
    contact_name = payload["context"]["facts"]["selected_contact"]["value"]
    contact_phone = payload["context"]["facts"]["phone_type"]["value"]
    phone_number = CONTACT[contact_name][contact_phone]
